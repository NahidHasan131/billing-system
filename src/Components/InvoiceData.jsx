...
const InvoiceData = ({setShowAddInvoice}) => {
    return (
        <div>
            <div className='d-flex justify-content-between align-items-center mb-4 invoice-title'>
                ...
                <button onClick={() => setShowAddInvoice(true)} className="btn invoice-btn rounded-pill px-4 py-2"><i className="fa-solid fa-circle-plus"></i> Add Invoice</button>
            </div>
